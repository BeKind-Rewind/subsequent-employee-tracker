...
INSERT INTO employee (id, first_name, last_name, role_id, manager_id)
    ...
    (2, 'Alyssa', 'McMullen', 2, NULL),
    (3, 'Lisa', 'Phillip', 2, NULL),
    (4, 'Olga', 'Rutnik', 3, 2),
    (5, 'Sam', 'Smith', 1, 3),
    (6, 'Jacob', 'Donnelly', 5, 3),
    (7, 'Ryan', 'Alexi', 4, 1),
    (8, 'Chris', 'Tiggs', 9, NULL),
    (9, 'Spencer', 'Olsen', 7, 2),
    (10, 'Tim', 'Sampson', 5, 2),
    (11, 'Cloud', 'Fife', 4, 3),
    (12, 'Stesha', 'Chavers', 2, NULL),
    (13, 'Stefan', 'Oliver', 6, 1),
    (14, 'Jon', 'Portteus', 7, 1),
    (15, 'Mitchell', 'Malik', 5, NULL),
    (16, 'Joi', 'Schultz', 8, 2),
    (17, 'Micah', 'Fugatello', 4, NULL),
    (18, 'Julie', 'Salva', 5, 3),
    (19, 'Rain', 'Moon', 1, 1),
    (20, 'Sparrow', 'Venti', 1, NULL);